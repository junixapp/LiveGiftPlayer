...
public class GLTextureView
    ...
    protected void finalize() throws Throwable {
        try {
            if (mGLThread != null) {
                // GLThread may still be running if this com.lxj.alphaplayer.view was never
    ...
    /**
     * Set the renderer associated with this com.lxj.alphaplayer.view. Also starts the thread that
     ...
     * com.lxj.alphaplayer.view will choose an EGLConfig that is compatible with the current
     * android.com.lxj.alphaplayer.view.Surface, with a depth buffer depth of
     * at least 16 bits.
     * @param configChooser
     */
     ...
     * <p>
     * If no setEGLConfigChooser method is called, then by default the
     * com.lxj.alphaplayer.view will choose an RGB_888 surface with a depth buffer depth of
     * at least 16 bits.
     *
     * @param needDepth
     */
     ...
     * by allowing the GPU and CPU to idle when the com.lxj.alphaplayer.view does not need to be updated.
     * <p>
    ...
    /**
     * Inform the com.lxj.alphaplayer.view that the activity is paused. The owner of this com.lxj.alphaplayer.view must
    ...
    /**
     * Inform the com.lxj.alphaplayer.view that the activity is resumed. The owner of this com.lxj.alphaplayer.view must
...
//        requestRender();
     ...
     * <p>Typically
     * used for implementing debugging and tracing on bottom of the default
    ...
    static class GLThread extends Thread {
                ...
                while (true) {
                    synchronized (sGLThreadManager) {
                        while (true) {
                            ...
                            // Have we acquired the surface com.lxj.alphaplayer.view surface?
                            if (mHasSurface && mWaitingForSurface) {
                                if (LOG_SURFACE) {
        ...
        /**
         * Set once at thread construction time, nulled out when the parent com.lxj.alphaplayer.view is garbage
